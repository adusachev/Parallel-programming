...
int main(int argc, char **argv) {
    ...
    std::cout << "Asked threads num from cli: " << asked_threads_num << std::endl;  
    ...
    # pragma omp parallel
    {
        ...
        #pragma omp master  // задает критическую секцию, в которую зайдет только один master поток
    ...
    std::cout << "Elapsed time: "  << end - begin << "; Sum " << sum << std::endl << std::endl;
}
